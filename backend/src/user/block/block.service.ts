...
export class    BlockService {
    ...
    */
    ...
    async blockFriend(blockSenderId: number, blockReceiverId: number)
    ...
    */
    ...
    async unblockFriend(blockSenderId: number, blockReceiverId: number)
                        : Promise<void> {
    ...
    async getBlockedFriends(userId: number): Promise<FriendDto[]> {
