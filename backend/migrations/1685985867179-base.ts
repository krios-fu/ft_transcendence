...
export class base1685985867179 implements MigrationInterface {
    name = 'base1685985867179'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "ban" ADD CONSTRAINT "FK_eced4a90a3dbd381124b86e0d51" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "ban" ADD CONSTRAINT "FK_fd3de5d2d4bbb83bb9246d61c21" FOREIGN KEY ("room_id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
